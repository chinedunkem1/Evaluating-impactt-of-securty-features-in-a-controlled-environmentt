...
def get_my_profile():
    ...
    return jsonify({'success': True, 'employee': current_user.employee.to_dict()}), 200
...
def get_payslip(payslip_id):
    ...
    # VULNERABLE: no ownership check - any employee can view any payslip by guessing the ID
    # e.g. /api/employee/payslips/1, /api/employee/payslips/2 etc
